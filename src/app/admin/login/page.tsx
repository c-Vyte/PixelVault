    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0f1a] px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-blue-300/60 text-sm mt-2">Enter password to continue</p>
        </div>

        <form onSubmit={handleSubmit} className="bg-[#111827] rounded-xl border border-blue-900/30 p-6">
          <div className="mb-4">
            ...
            <input
              ...
              autoFocus
              className="w-full bg-[#0c1222] text-white rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 border border-blue-900/30 text-sm"
            />
          </div>
