...
import { getDeadLinkReports } from "@/lib/workflowStore";
...
const navItems = [
  ...
  },
  {
    ...
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 5a2 2 0 012-2h12a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm4 3h8M8 12h8M8 16h5" />
      </svg>
    ),
  },
];
...
export default function AdminSidebar() {
  ...
  useEffect(() => {
    const update = () => {
      setPendingReports(getDeadLinkReports().filter((r) => r.status === "pending").length);
    };
    update();
            ...
            return (
              <li key={item.href}>
                ...
                >
                  ...
                  {isActive && item.href !== "/admin/reports" && (
