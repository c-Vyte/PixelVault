...
const content = fs.readFileSync('C:/fileshare/src/app/admin/external-data/page.tsx', 'utf8');
...
// Reconstruct
const newContent = content.substring(0, content.indexOf('function toSoftware')) + fnFixed + afterFn;
